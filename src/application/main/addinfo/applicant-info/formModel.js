...
alpha_spaces
:
ƒ alpha_spaces(field)
bankcard
:
ƒ cn(field, args)
before
:
ƒ before(field, _ref3)
between
:
ƒ between(field, _ref5)
byte20
:
ƒ cn(field, args)
byte100
...
confirmed
:
ƒ confirmed(field, _ref7)
date_between
:
ƒ date_between(field, _ref9)
date_format
:
ƒ date_format(field, _ref11)
decimal
:
ƒ decimal(field)
digits
:
ƒ digits(field, _ref15)
dimensions
:
ƒ dimensions(field, _ref17)
email
:
ƒ email(field)
ext
