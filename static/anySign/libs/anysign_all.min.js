...
function anysignCommentCore(a, b, c, d) {
  ...
  function g() {
    ...
    h.fillStyle = "#fff";
    h.fill();
    var f = 0, u = 0, e = v.length;
    b(0)
  }

  var k = 480 <= window.innerWidth ? 15 : 10, l = !1, p = !1, w = 9999, r = 9999, q = 0, h = 0, m = 0, u = 0, y = [],
    E = [], B = [], F = 0, H = "", K = 0, A, x, I, n = 0, J = [], C = null, Q = 0, M = 0, N, O, P = !1,
    v = a.replace(/(.)(?=[^$])/g, "$1,").split(",");
  A = document.getElementById("comment_canvas");
  var D = document.getElementById("comment_title"), G = document.getElementById("signImage"),
    S = document.getElementById("comment_ok"), T = document.getElementById("comment_back"),
  ...
  T.onclick = function () {
    if (!p) if (0 >= n) alert("\u5df2\u79fb\u9664\u5b8c\uff0c\u8bf7\u91cd\u65b0\u8fdb\u884c\u7b7e\u540d\uff01"); else {
  ...
  "ontouchstart" in document.documentElement ? (A.ontouchstart = function (a) {
    ...
    if (l) {
      ...
      0 < m && u <= A.height && (H = isNaN(c) ? H + (m + "," + u + "," + k + ",0\n") : H + (m + "," + u + "," + k + "," + (c - F) + "\n"), K += 1, m > q && (q = m), m < w && (w = m), u > h && (h = u), u < r && (r = u), y.push({
        x: m,
        y: u
      }), R(), E.push({x: m, y: u}), 0 < m && 0 < u && B.push(m, u));
      preventDefault(a)
    }
        ...
        if (c.isdistinguish && !checkText(v[n])) showProgress("\u6b63\u5728\u8bc6\u522b\uff0c\u8bf7\u7a0d\u5019\u3002\u3002\u3002"), (new OCRObj(c.ocrCapture)).recognition(B, v[n], function (b, m) {
          ...
          if (0 == b) {
            if (m) {
              ...
              if (checkText(v[n - 1])) g.src = u.toDataURL("image/png"); else {
                var y = q - w, k = h - r, l = (q + w) / 2, p = (h + r) / 2,
          ...
          if (checkText(v[n - 1])) b.src = u.toDataURL("image/png"); else {
            var m = q - w, g = h - r, y = (q + w) / 2, k = (h + r) / 2,
    ...
    if (l) {
      var c = JQuery_Capable.offset(a.target), b = document.body.scrollTop | document.documentElement.scrollTop,
        ...
        if (c.isdistinguish && !checkText(v[n])) showProgress("\u6b63\u5728\u8bc6\u522b\uff0c\u8bf7\u7a0d\u5019\u3002\u3002\u3002"), (new OCRObj(c.ocrCapture)).recognition(B, v[n], function (b, u) {
          ...
          if (0 == b) {
            if (u) {
              ...
              if (checkText(v[n - 1])) e.src = g.toDataURL("image/png"); else {
                var m = q - w, y = h - r, l = (q + w) / 2, p = (h + r) / 2,
          ...
          b.width = c.mass_word_width;
          b.height = c.mass_word_height;
          if (checkText(v[n - 1])) b.src = g.toDataURL("image/png"); else {
            var u = q - w, e = h - r, m = (q + w) / 2, y = (h + r) / 2,
...
var AnySignRoot = function () {
    ...
    this.result = [];
    this.errCode = null
  }, RESULT_OK = 0, RESULT_ERROR = -1, EC_API_NOT_INITED = 1, EC_WRONG_CONTEXT_ID = 2, EC_NATIVE_EXCEPTION = 3,
  EC_TEMPLATE_NOT_SET = 4, EC_COMMENT_ALREADY_SHOW = 5, CALLBACK_TYPE_SIGNATURE = 10,
  CALLBACK_TYPE_DIALOG_CANCEL = 11, CALLBACK_TYPE_COMMENTSIGN = 12, CALLBACK_TYPE_GETVERSION = 13,
  CALLBACK_TYPE_START_RECORDING = 14, CALLBACK_TYPE_STOP_RECORDING = 15, isCommentShow = !1;
...
function anysignWebImpl() {
  ...
  var b, c = !1, d = !1, f, e, g, k = [], l = [], p = [], w = [], r = [], q;
  ...
  this._showSignatureDialog = function (a) {
    if (c) {
      if (d) {
        ...
        var e = l[a];
        a = getWindowHeight();
        var f = getWindowWidth(), h = document.getElementById("dialog");
        h.style.height = a;
        h.style.width = f;
  ...
  this._restoreBusinessSession = function (a, b) {
    ...
    b = b.substring(0, 24);
    var h = tripleDesDecrypt(a, b) + "", h = anysign.hex.hexStrToUint8Str(h), h = anysign.json.stringToObj(h);
    f = h.WONo;
    e = h.WOHash;
    g = h.Channel;
  ...
  this._getUploadDataGram = function () {
    if (c && this._isReadyToUpload() && d) {
      var a = new AnySignRoot, b = new FormInfo, u = new Uint8Array(24);
  ...
  this._getOSInfo = function () {
    if (isMobile.Android()) {
      ...
      alert(a);
      var b = a.indexOf("android"), c = a.indexOf(";", b), a = a.substring(b + 8, c);
      return "android##" + a
    }
...
function am2(a, b, c, d, f, e) {
  var g = b & 32767;
  for (b >>= 15; 0 <= --e;) {
    var k = this[a] & 32767, l = this[a++] >> 15, p = b * k + l * g,
...
function am3(a, b, c, d, f, e) {
  var g = b & 16383;
  for (b >>= 14; 0 <= --e;) {
    var k = this[a] & 16383, l = this[a++] >> 14, p = b * k + l * g, k = g * k + ((p & 16383) << 14) + c[d] + f;
    f = (k >> 28) + (p >> 14) + b * l;
    c[d++] = k & 268435455
  }
  return f
...
function bnpLShiftTo(a, b) {
  var c = a % this.DB, d = this.DB - c, f = (1 << d) - 1, e = Math.floor(a / this.DB), g = this.s << c & this.DM, k;
...
function bnpDivRemTo(a, b, c) {
  ...
  if (!(0 >= d.t)) {
    ...
    if (f.t < d.t) null != b && b.fromInt(0), null != c && this.copyTo(c); else {
      ...
      f = e[d - 1];
      if (0 != f) {
        var l = f * (1 << this.F1) + (1 < d ? e[d - 2] >> this.F2 : 0), p = this.FV / l, l = (1 << this.F1) / l,
          w = 1 << this.F2, r = c.t, q = r - d, h = null == b ? nbi() : b;
        e.dlShiftTo(q, h);
...
function tripleDesEncrypt(a, b) {
  var c = CryptoJS.enc.Hex.parse(b);
  return CryptoJS.TripleDES.encrypt(a, c, {mode: CryptoJS.mode.ECB, padding: CryptoJS.pad.Pkcs7})
}

function tripleDesDecrypt(a, b) {
  var c = CryptoJS.enc.Hex.parse(b);
  return CryptoJS.TripleDES.decrypt(a, c, {mode: CryptoJS.mode.ECB, padding: CryptoJS.pad.Pkcs7})
}
...
var pubN = "",
  pubE = "10001", encCertSN = "‎0990990000018f0281";
...
var anysign = anysign && {
  ...
  decode: function (a) {
    var b = .75 * a.length, c = a.length, d = 0, f, e, g, k;
  ...
  binary: {
    ...
    hexEncodeArray: "0123456789abcdef".split(""), uint8ArrayToHexStr: function (a) {
      if (!a) return null;
      for (var b = "", c = 0; c < a.length; c++) var d = a[c], b = b + this.hexEncodeArray[d >>> 4], b = b + this.hexEncodeArray[d & 15];
      return b
    ...
    crc32: function (a) {
      var b = [];
      if (window.crcTable) b = window.crcTable; else {
...
(function (a) {
  ...
  var g = a.document, k = g.createElement("script"), l = g.getElementsByTagName("script")[0], p = [], w = 0, r, q, h;
...
var points = [], firstPointTime = 0, signTrack = "", signTrachPointCount = 0, calculatedSigWidth = 0,
  calculatedSigHeight = 0, minX = 9999, minY = 9999, maxX = 0, maxY = 0, curX = 0, curY = 0, lastX = 0, lastY = 0,
  paste_padding = 10, imageDataTmp, isDown = !1, isDrawn = !1, isAnysignInputDlgShown = !1, isCopyingImg = !1,
  base_stroke_width = 480 <= window.innerWidth ? 7.5 : 5, canvas, ctx, signResCallback, signObjTmp,
  bh_temp = getWindowHeight(), bw_temp = getWindowWidth(), isSign, sbuilder = [], identify_callback,
  fresh = function () {
    if (isSign) {
      var a = ismobile(1);
      if (1 == a) {
        var b = document.getElementById("anysignCanvas"), c = b.getContext("2d"), d, f, e, g, k;
        if (isDrawn) {
          d = document.createElement("canvas");
          f = d.getContext("2d");
          var l = paste_padding, p = g = e = l, w = l, r, q;
        ...
        var a = getWindowHeight(), h = getWindowWidth();
...
function onload_singleSignCanvas() {
  if (document.getElementById("anysignCanvas")) {
    ...
    var a = getWindowHeight(), b = getWindowWidth();
...
function onload_singleSingScrollAction() {
  ...
  var c = 0, d = 0, f = 0, e = document.getElementById("container");
  ...
  document.getElementById("single_scrollbar_down").addEventListener("click", function () {
    var a = e.clientWidth, g = e.scrollWidth;
    c = Math.ceil(1 * a / 3);
    f = d + c >= g - a ? g - a : d + c;
    b()
  });
...
function clear_canvas() {
  var a = document.getElementById("anysignCanvas"), b = a.getContext("2d");
  ...
  if (isDrawn) if (signObjTmp.isdistinguish) {
    ...
    (new OCRObj(signObjTmp.ocrCapture)).recognition(sbuilder, a, function (a, b) {
      ...
      if (0 == a) {
        ...
        if (signResCallback) {
          var d = getSigData(), c = document.getElementById("anysignCanvas");
...
function setSignResCallback(a, b) {
  if (isSignOrCom(a.cid)) {
    signObjTmp = a;
    signResCallback = b;
    var c = document.getElementById("anysignCanvas"), c = c.getContext("2d");
    c.strokeStyle = signObjTmp ? signObjTmp.penColor : "black"
...
function testEncAndDec() {
  var a = tripleDesEncrypt("abdfdsafdasfcdef132432432432g\u4f60\u597d\u5417,,,fdafdas", "133434") + "",
    b = tripleDesDecrypt(a, "133434") + "", b = anysign.hex.hexStrToUint8Str(b),
...
var JQuery_Capable = {
  offset: function (a) {
    var b, c = {top: 0, left: 0}, d = a && a.ownerDocument;
...
}, isIe = document.all ? !0 : !1, messContent;
...
function showBackground(a, b) {
  if (isIe) a.filters.alpha.opacity += 1, a.filters.alpha.opacity < b && setTimeout(function () {
    ...
    var c = parseFloat(a.style.opacity), c = c + .01;
    a.style.opacity = c;
...
(function () {
  var a = function () {
    var a = Array.prototype.slice.call(this.getContext("2d").getImageData(0, 0, this.width, this.height).data),
      b = this.width, f = this.height, e = [137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82];
...
function OCRObj(a) {
  ...
  null == b.appID || "" == b.appID || void 0 == b.appID ? console.log("ocrCapture.appID is null") : (c.userID = b.appID, null == b.serviceID || "" == b.serviceID || void 0 == b.serviceID ? console.log("ocrCapture.serviceID is null") : (c.serviceID = b.serviceID, d.type = 1, b.language == Language.CHS ? d.lang = "1" : b.language == Language.CHT && (d.lang = "2"), d.similar = b.resolution, d.text = b.text, d.hwrNum = b.count, c.hwrInfo = d, this.recognition = function (a, k, l) {
    ...
    null == b.IPAdress || "" == b.IPAdress || void 0 == b.IPAdress ? f("\u670d\u52a1\u5668\u5730\u5740\u4e3a\u7a7a\uff01", e) : jQuery.ajax({
      ...
      url: b.IPAdress,
      success: function (a) {
        if (null == a || "undefined" == a || "" == a) f("\u94fe\u63a5\u670d\u52a1\u5668\u5f02\u5e38,\u8bf7\u68c0\u67e5\u7f51\u7edc\uff01", e); else {
          a = JSON.parse(a);
          if (null == a || "undefined" == typeof a) alert("\u670d\u52a1\u5668\u8fde\u63a5\u5931\u8d25,\u8bf7\u7a0d\u540e\u518d\u6b21\u5c1d\u8bd5"); else if ("0" == a.errCode) for (var b = a.result, c = "", d = 0; d < b.length; d++) if ("0" == b[d]) {
            if (k == c) {
              e = !0;
              break
            }
            c = ""
          } else var g = String.fromCharCode(b[d]), c = c + g;
          0 != a.errCode || e ? f(a.errCode, e) : f("-1", e)
        }
      },
      error: function (a, b, c) {
        f("\u8bf7\u6c42\u8d85\u65f6", e);
        if ("timeout" == b) alert("\u8bf7\u6c42\u8d85\u65f6,\u8bf7\u7a0d\u540e\u518d\u6b21\u5c1d\u8bd5"); else return alert("\u8fde\u63a5\u670d\u52a1\u7aef\u5f02\u5e38: " + b + "\uff1bstatus code\uff1a" + a.status + "\uff1bstate\uff1a" + a.readyState), a = document.getElementById("comment_canvas"), a.getContext("2d").clearRect(0, 0, a.width, a.height), !1
      }
    })
  }))
}
